...
window.SOULS = {
  links: {
    ...
    /* Письмо автору — один адрес на весь сайт: и «Write to Diana» после
       стихов на «Авторе», и кнопка внизу страницы.
       ЗАГЛУШКА: почта ещё не заведена (24.09). Когда появится настоящий
       адрес — заменить здесь, больше нигде: страница берёт его отсюда. */
    email: "mailto:letters@raydizhe.com"
  },
